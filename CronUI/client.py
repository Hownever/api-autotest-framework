...
class HttpSession(requests.Session):
    ...
    def lower_dict_keys(self, origin_dict):
    ...
    def omit_long_data(self, body, omit_len=512):
    ...
    def get_req_resp_record(self, resp_obj):
        ...
        if request_body:
            request_content_type = self.lower_dict_keys(
        ...
        lower_resp_headers = self.lower_dict_keys(resp_headers)
        ...
        if "image" in content_type:
            ...
            try:
                ...
                req_resp_dict["response"]["text"] = self.omit_long_data(resp_text)
