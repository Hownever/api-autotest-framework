...
def hook_update_jdcloud_request(config, request, ak, sk, product, version, spec):
    ...
    if params is not None:
        if isinstance(params, dict):
            ...
            raise exceptions.ParamsError("params format error: %s" % params)
...
if __name__ == "__main__":
    yamlfile = "E:\WorkSpace\SourceCode\others\jcloud-open-api-yaml"
    apis, outapis = get_apis_for_serviceline_from_yaml(yamlfile, "ossopenapi")
    print(apis)
    print(outapis)
